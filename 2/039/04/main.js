$(".start").click(function () {
  ...
  fire_modal(
    ...
    "Yunaa..ayo bikin kue :)",
    "Happy birthday yang ke 22 th yaaa.. ciee dah tambah tambah nihhh, ayo bikin kuee "
  );
});
...
$(".mixer").click(function () {
  ...
  if (mixtimes == 6) {
    ...
    fire_modal(
      ...
      "Selamat Yunaa 🔥, kmu udah nyampurin dengan sempurna. nah sekarang ayo kita oven."
    );
  }
});
